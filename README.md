...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/anish-gutha7)
[![Email](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:vza2ne@virginia.edu)
...
- Role-based access control: players, captains, and user admins
- Features: team creation, join requests, scheduling, direct messaging, free agent board
- Deployed on **Heroku** with full CI/CD pipeline via GitHub Actions
- `Python` `Django` `PostgreSQL` `HTML/CSS` `Heroku`
...
- Built statistical models to evaluate trade-offs and optimal placement
- `Python` `Data Analysis` `Probability` `Pandas`
...
- Custom domain deployed at [truecrimevault.net](https://truecrimevault.net)
...
![Anish's GitHub Stats](https://github-readme-stats.vercel.app/api?username=Anish1066&show_icons=true&theme=tokyonight&hide_border=true&count_private=true)
...
*Open to SWE internships and new grad roles — feel free to reach out!*
